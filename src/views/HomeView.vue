<template>
  <div class="home-view-container relative bg-[#FFF9F9]">
    <Hero />
    
    <!-- We can uncomment these components as needed -->
    <!-- <CollectionsView /> -->
    <!-- <CollectionList /> -->
    <!-- <DecorationGrid /> -->
    <!-- <GalleryView /> -->
    
    <!-- Élément décoratif en bas si nécessaire -->
...
<style scoped>
/* Animations qui pourraient être nécessaires */
.animate-pulse-slow {
