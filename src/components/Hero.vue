  ...
  <div class="home-container min-h-[190vh] relative">
    ...
    <section class="flex flex-col justify-center relative overflow-hidden">
      <div class="container mx-auto px-4 relative z-10">
        <div
          class="flex flex-col md:flex-row justify-between items-center mt-8 md:mt-12 gap-8 md:gap-0"
        >
          <h1
            class="text-6xl sm:text-8xl md:text-[160px] text-[#231f21] font-normal font-inter leading-normal md:leading-[120px] whitespace-nowrap md:mr-20 text-center md:text-left animate-fade-in-left"
          >
            We love.
          </h1>
          <div class="relative mr-4 md:mr-8 lg:mr-12">
            <div
              class="absolute -inset-4 bg-gradient-to-r from-pink-200 to-pink-300 rounded-full blur-md animate-pulse"
            ></div>
            <img
              src="@/assets/hero.png"
              alt="Beach lifestyle"
      ...
      <div
        class="absolute top-1/4 left-[10%] w-20 h-20 rounded-full bg-pink-100 opacity-60 animate-float-slow"
      ></div>
      <div
        class="absolute bottom-1/4 right-[15%] w-32 h-32 rounded-full bg-pink-200 opacity-50 animate-float-medium"
      ></div>
      <div
        class="absolute top-[60%] left-[20%] w-16 h-16 rounded-full bg-pink-300 opacity-40 animate-float-fast"
      ></div>
    </section>
    ...
    <section
      id="featured"
      class="min-h-screen py-20 relative opacity-0 transition-opacity duration-700 ease-in-out"
    >
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 fade-in-scroll">
          ...
          >
            <div
              class="aspect-square overflow-hidden bg-[#FFF0F8] rounded-lg relative"
            >
              <!-- Logo en arrière-plan -->
              <div
                class="absolute inset-0 flex items-center justify-center p-4 opacity-25"
              >
                <img
                  src="@/assets/logo.png"
                  alt="Calypso"
    ...
    >
      ...
      >
        <div class="md:w-1/2 fade-in-scroll">
          <h2
            class="text-5xl md:text-7xl text-[#231f21] font-normal font-inter mb-8"
          >
            Notre histoire.
          </h2>
      ...
      >
        <div class="absolute bottom-0 left-0 w-full h-full">
          <div
            class="absolute bottom-0 left-0 w-full h-[80px] bg-[#FFF0F8]"
          ></div>
          <div
            class="absolute bottom-[60px] left-[5%] w-[90%] h-[1px] bg-pink-200"
          ></div>
          <div
            class="absolute bottom-[60px] left-[10%] w-3 h-3 rounded-full bg-pink-300 animate-pulse-slow"
          ></div>
          <div
            class="absolute bottom-[60px] left-[30%] w-2 h-2 rounded-full bg-pink-200 animate-pulse-medium"
          ></div>
          <div
            class="absolute bottom-[60px] left-[50%] w-4 h-4 rounded-full bg-pink-300 animate-pulse-slow"
          ></div>
          <div
            class="absolute bottom-[60px] left-[70%] w-2 h-2 rounded-full bg-pink-200 animate-pulse-medium"
          ></div>
          <div
            class="absolute bottom-[60px] left-[90%] w-3 h-3 rounded-full bg-pink-300 animate-pulse-slow"
          ></div>
        </div>
      </div>
    </section>
    ...
    <section
      class="py-20 bg-[#FFF0F8] relative opacity-0 transition-opacity duration-700 ease-in-out"
    >
      <div class="container mx-auto px-4">
        <h2
          class="text-5xl md:text-7xl text-[#231f21] font-normal font-inter mb-16 text-center fade-in-scroll"
        >
          Suivez-nous.
        </h2>
        <a href="https://www.instagram.com/calypso.mq/" target="_blank">
          <p class="text-2xl text-center mb-12 fade-in-scroll">@calypso.mq</p>
        </a>

        <!-- Grille Instagram -->
        <div
          class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 fade-in-scroll"
        >
          <div
...
onMounted(() => {
  ...
  document
    .querySelectorAll(".fade-in-scroll, section:not(:first-child)")
    .forEach((el) => {
      observer.observe(el);
    });
});
